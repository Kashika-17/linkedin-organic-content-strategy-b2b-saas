...
This project was completed as part of the **100Hires Technical Assessment**.

Requirements included:

- Selecting one B2B SaaS marketing topic
- Identifying high-quality practitioners
- Collecting content using APIs where applicable
- Organizing research inside a GitHub repository
- Demonstrating technical ability with Python and API integration
- Building research that can later become a practical marketing playbook
